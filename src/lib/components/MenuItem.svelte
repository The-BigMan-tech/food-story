<script>
    let {image,text,star_img,star_count,reviews,price,buy} = $props()
    function order() {
...
<div class="flex flex-col bg-[#c63451] w-72 h-[21rem] items-center pt-7 rounded-xl text-white shadow-xl">
    ...
    <div class="flex gap-3 relative top-3">
        ...
        <button onclick={order} class="bg-white text-[#c63451] py-2 px-6 relative left-4 bottom-1 rounded-2xl">{buy}</button>
    </div>
</div>